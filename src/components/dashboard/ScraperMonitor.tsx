    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Fila e Histórico do Scraper</h1>
            <p className="text-sm text-muted-foreground">Status de todos os downloads e indexações.</p>
          </div>
